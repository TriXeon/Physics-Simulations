...
pos1 = np.array([-1.0e11, 0.0])   # Initial position of body 1, m
pos2 = np.array([1.0e11, 0.0])    # Initial position of body 2, m
vel1 = np.array([0.0, 1.0e4])     # Initial velocity of body 1, m/s
vel2 = np.array([0.0, -1.5e4])    # Initial velocity of body 2, m/s
